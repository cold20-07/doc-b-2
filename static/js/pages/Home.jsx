            ...
            <div className="space-y-8 animate-fade-in-left">
              ...
              <div className="glass-strong rounded-2xl p-6 space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <a href="tel:9279816626" className="text-gray-800 font-semibold hover:text-sky-600 transition-colors">
                    +91 9279816626
                  </a>
                </div>
                <div className="flex items-center gap-3">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={index}
                className={`service-card animate-fade-in-up delay-${index * 200}`}
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:9279816626" className="text-sm text-sky-600 hover:text-sky-700 font-medium" data-testid="clinic-phone">
                        +91 9279816626
                      </a>
